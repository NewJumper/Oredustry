...
public class MeltingRecipeBuilder implements RecipeBuilder {
    ...
    public MeltingRecipeBuilder(ItemLike ingredient, ItemLike result, int count, float experience) {
        this(Ingredient.of(ingredient), result, count, experience, 150);
    }

    public MeltingRecipeBuilder(TagKey<Item> ingredient, ItemLike result, int count, float experience) {
        this(Ingredient.of(ingredient), result, count, experience, 150);
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId) {
        ...
        consumer.accept(new MeltingRecipeBuilder.Result(recipeId, this.ingredient, this.result, this.count, this.experience, this.time, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + RecipeCategory.MISC.getFolderName() + "/" + recipeId.getPath())));
    }
